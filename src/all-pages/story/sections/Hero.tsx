                ...
                <Container>
                    <div className="rounded-3xl bg-white w-full my-20 shadow-[0px_0px_8px_3px] shadow-[#0000001A]">
                        <div className="max-w-[750px]  mx-auto text-center p-5 text-base font-normal space-y-5 mt-20">
                            ...
                            <p className="font-medium text-lg lg:text-2xl">〜難⺠でも楽しく⽣活できる世界観がこの会社にはある〜</p>
                            <p className="font-bold text-[#A8A8A8] text-xs lg:text-base font-Figma-Hand">This company has a worldview that even refugees can enjoy l iving in.</p>
